...
export class IncomeAndExpanses {
    ...
    renderIncomeExpense(result) {
        ...
        result.forEach((item, index) => {
            const newBlock = `<tr class="trData">
                                  ...
                                  <td>
                                    <div>
                                      <svg class="trashbox-svg" width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <svg class="pen-svg" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
